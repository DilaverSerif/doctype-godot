...
void test_text_transform()
{
    ...
    check(tf("ışık", litehtml::text_transform_uppercase) == "IŞIK",
          "without tr, dotless i still uppercases to I, not to İ");
    check(tf("İSTANBUL", litehtml::text_transform_lowercase) == "istanbul",
          "without tr, dotted capital lowercases to plain i, not to ı");
}
